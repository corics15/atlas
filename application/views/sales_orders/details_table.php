    ...
    <div class="card">
        ...
        <div class="ml-auto">
          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <button type="button" class="btn btn-sm btn-link" id="btnViewSOPDF"><i class="fa fa-file-pdf mr-2"></i>View As PDF</button>
            </div>
          </div>
      ...
      <div class="card-body p-0">
        <div class="table-responsive">
          <table class="table table-sm table-hover mb-0 atlas-entry-table">
          ...
          <div class="align-items-end col-md-8 d-flex">
            <div class="alert alert-light font-sm mb-0" role="alert">
              ...
              <div>
                ...
                <span class="font-weight-500 text-danger">Qty</span>. Check the available stock before proceeding.
              </div>

              <div>
                <span class="font-weight-500">3.</span>
                Review the <span class="font-weight-500 text-danger">Unit Price</span> and apply a
                <span class="font-weight-500 text-danger">Percent (%)</span> or <span class="font-weight-500 text-danger">Amount</span> discount when applicable.
              </div>

              <div>
                <span class="font-weight-500">4.</span>
                Review the calculated totals, then click
                <span class="font-weight-500 text-brown">Save Sales Order</span>.
              </div>

              <div>
                <span class="font-weight-500">5.</span>
                <span class="font-weight-500 text-orange">Post</span> the Sales Order when finalized.
                A posted Sales Order can then be used to
                <span class="font-weight-500 text-olive">Create Delivery Receipt</span>.
              </div>
            </div>
          </div>
          <div class="col-md-4">
