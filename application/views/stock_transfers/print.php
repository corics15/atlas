<?php foreach ($documents as $i => $document): ?>
  ...
  <div class="report">
    <table class="table report-borderless table-sm mb-3">
      <tr>
        <td width="180"><strong>Transfer No.</strong></td>
        <td><?= $header->transfer_no ?></td>
      </tr>
      <tr>
        <td><strong>Transfer Date</strong></td>
        <td><?= date('m/d/Y', strtotime($header->transfer_date)) ?></td>
      </tr>
      <tr>
        <td><strong>From Branch</strong></td>
        <td><?= $header->from_branch ?></td>
      </tr>
      <tr>
        <td><strong>To Branch</strong></td>
        <td><?= $header->to_branch ?></td>
      </tr>
      <tr>
