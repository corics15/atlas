<?php if (false) : ?>
<div class="modal fade" id="mdlCustomer" tabindex="-1">
      ...
      <form id="frmCustomer">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text"
              id="txtCustomerName" name="customer_name"
              class="form-control form-control-sm uppercase">
              <small id="errCustomerName" class="text-danger d-block"></small>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text"
              ...
              <small id="errEmailAddress" class="text-danger d-block"></small>
          </div>
          ...
          <div class="form-group">
            ...
            <small id="errSalesmanId" class="text-danger d-block"></small>
          </div>

          <div class="form-group">
            <label for="txtTerms">Terms</label>
            <input type="text"
              id="txtTerms" name="terms"
              class="form-control form-control-sm">
              <small id="errTerms" class="text-danger d-block"></small>
          </div>

          <div class="form-group">
            <label for="txtCreditLimit">Credit Limit</label>
            <input type="text"
              id="txtCreditLimit" name="credit_limit"
              class="form-control form-control-sm">
              <small id="errCreditLimit" class="text-danger d-block"></small>
          </div>
        </div>
      ...
      <form id="frmCustomer">
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              <label for="txtTerms">Terms</label>
              <input type="text" id="txtTerms" name="terms"
                     class="form-control form-control-sm" placeholder="e.g. Net 30">
