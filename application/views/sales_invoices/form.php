          ...
          <div class="col-md-6">
            ...
            <table class="table table-sm table-borderless">
              ...
              <tr>
                ...
                <td>
                  <a href="<?= base_url('delivery-receipts/edit/'). ($isEdit ? $header->delivery_receipt_id : $header->id) ?>" class="text-wrap text-olive" target="_blank"><i class="fa-external-link-alt fas font-smr mr-1"></i><?= htmlspecialchars($header->dr_no) ?></a>
              </tr>
              <tr>
                <th>Delivery Date</th>
